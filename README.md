...
|---------------------------|---------------------|----------------|
| **[kernel-backport/main](https://github.com/intel-gpu/xekmd-backports/tree/kernel-backport/main)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/kernel-backport/main/README.md)) <br> *Status:* **Active** (Recommended) <br> *Kernel:* v7.1+ <br> *Description:* Primary backport branch with in-tree patches. Latest features: EU debugging. Can be used for full kernel builds |**[oot-backport/main](https://github.com/intel-gpu/xekmd-backports/tree/oot-backport/main)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/oot-backport/main/autotools/README.md)) <br><br> *Status:* **Active** <br><br> *Description:* Contains tools that process kernel-backport branches to generate OOT source code with compatibility layers, DKMS support, and build configurations for releases branch | **[releases/main](https://github.com/intel-gpu/xekmd-backports/tree/releases/main)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/releases/main/README.md)) <br><br> *Status:* **Active** <br><br> *Description:* Out-of-tree source code for xe and other required modules. End users can build and install DKMS modules from this source <br><br>  $\color{red}{LIMITATION: \space Display \space is \space not \space supported \space with \space DKMS \space releases}$|
| **[kernel-backport/v7.0](https://github.com/intel-gpu/xekmd-backports/tree/kernel-backport/v7.0)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/kernel-backport/v7.0/README.md)) <br> *Status:* **Frozen** <br> *Kernel:* v7.0 <br> *Description:* In-tree backport patches. Latest features: vf vram provision, EU debugging. Can be used for full kernel builds |||
| **[kernel-backport/v6.17](https://github.com/intel-gpu/xekmd-backports/tree/kernel-backport/main)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/kernel-backport/v6.17/README.md)) <br> *Status:* **Frozen** <br> *Kernel:* v6.17 <br> *Description:* In-tree backport patches. Latest features: PMU, hwmon, SR-IOV, EU debugging, Xe2 HPG. Can be used for full kernel builds |**[oot-backport/v6.17](https://github.com/intel-gpu/xekmd-backports/tree/oot-backport/v6.17)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/oot-backport/v6.17/autotools/README.md)) <br><br> *Status:* **Frozen** <br><br> *Description:* Contains tools that process kernel-backport branches to generate OOT source code with compatibility layers, DKMS support, and build configurations for releases branch | **[releases/v6.17](https://github.com/intel-gpu/xekmd-backports/tree/releases/v6.17)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/releases/v6.17/README.md)) <br><br> *Status:* **Frozen** <br><br> *Description:* Out-of-tree source code for xe and other required modules. End users can build and install DKMS modules from this source <br><br>  $\color{red}{LIMITATION: \space Display \space is \space not \space supported \space with \space DKMS \space releases}$|
...
These branches provide essential kernel patches required to run Intel® Xe Graphics Driver alongside the DKMS releases. The patches backport critical kernel subsystem features (PCI, MM, I2C etc.) from upstream kernels. Without these patches, dependent Xe driver features will have limitations or will not work.
...
Note: See each branch's README for information for needed kernel patches and application instructions.
