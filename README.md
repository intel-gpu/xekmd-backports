...
| **[kernel-backport/v7.0](https://github.com/intel-gpu/xekmd-backports/tree/kernel-backport/v7.0)** ([README](https://github.com/intel-gpu/xekmd-backports/blob/kernel-backport/v7.0/README.md)) <br> *Status:* **Active** (Recommended) <br> *Kernel:* v7.0 <br> *Description:* In-tree backport patches. Latest features: vf vram provision, EU debugging. Can be used for full kernel builds |||
