...
#if IS_ENABLED(CPTCFG_VFIO_GROUP)
struct vfio_group {
	struct device 			dev;
	struct cdev			cdev;
	/*
...
#if IS_ENABLED(CPTCFG_VFIO_CONTAINER)
...
{
	return IS_ENABLED(CPTCFG_VFIO_NOIOMMU) &&
...
#if IS_ENABLED(CPTCFG_VFIO_DEVICE_CDEV)
...
#endif /* CPTCFG_VFIO_DEVICE_CDEV */

#if IS_ENABLED(CPTCFG_VFIO_VIRQFD)
