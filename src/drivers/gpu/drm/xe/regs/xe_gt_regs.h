...
#define   TD_CTL_ENABLE_EXID_FILTER		REG_BIT(17)
...
#define   CHICK_HANG_SEND_EXCEPTION		REG_BIT(15)
...
#define GADSS_CHICKEN				XE_REG_MCR(0xe700, XE_REG_OPTION_MASKED)
#define   GADSS_RDRTN_BROADCAST_DIS		REG_BIT(7)
