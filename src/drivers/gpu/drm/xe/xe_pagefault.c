				...
				struct xe_eudebug_pagefault **out_eudbg_pf)
{
	...
	eudbg_pf = prelim_xe_eudebug_pagefault_create(gt, vm, pf);
...
unlock_vm:
	...
	if (destroy_eudbg_pf) {
		prelim_xe_eudebug_pagefault_finalize(eudbg_pf, true);
		eudbg_pf = NULL;
	}
